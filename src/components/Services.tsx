...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      detailedContent: "Create stunning visual experiences that captivate your audience. Our design team crafts intuitive user interfaces, compelling brand identities, and seamless user experiences. We conduct user research, create wireframes and prototypes, design responsive layouts, and ensure accessibility standards are met across all platforms.",
    ...
    },
    {
      ...
      detailedContent: "Navigate your digital transformation with expert guidance. We provide strategic IT consulting, system architecture planning, technology audits, security assessments, and ongoing technical support. Our consultants help you choose the right technologies, optimize existing systems, and plan for future growth.",
    ...
    },
    {
      ...
      detailedContent: "Turn your innovative ideas into market-ready products. We specialize in rapid MVP development, allowing you to test concepts quickly and gather user feedback. Our iterative approach includes market research, prototype development, user testing, and continuous refinement to ensure your product meets market demands.",
